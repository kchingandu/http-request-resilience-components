...
class ResiliencyStrategy {
    constructor(config = {}) {
        ...
        this.backOffStatusCodeRegex =
            new RegExp(`(${statusCodes.TOO_MANY_REQUESTS}|${statusCodes.REQUEST_TIMEOUT}|5\\d{2})`);
    }
    ...
    getTimeoutInterval() {
        return this.config.timeoutsIntervals[this.currentAttempt];
    }
